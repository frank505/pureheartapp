...
import { getSharedVictories } from '../store/slices/victorySlice';
...
const SharedVictoriesList = ({ navigation, searchQuery = '' }: SharedVictoriesListProps) => {
  ...
  return (
    <View style={styles.container}>
      {loading && sharedVictories?.items.length === 0 && (
      ...
      <FlatList
        ...
        ListEmptyComponent={!loading ? (
          <View style={{ alignItems: 'center', padding: 16 }}>
            <Text style={{ color: Colors.text.secondary }}>No victories have been shared with you yet.</Text>
          </View>
        ) : null}
      />
    </View>
...
export default SharedVictoriesList;
