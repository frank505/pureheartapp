    ...
    <SafeAreaView edges={['top']} style={styles.container}>
      ...
      <View style={styles.actionsRow}>
        <TouchableOpacity style={[styles.btn, styles.btnMuted]} onPress={goToJournals}>
          <Text style={[styles.btnText, { color: '#1a1a1a' }]}>Journals</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.btn, styles.btnPrimary]} onPress={handleEnd}>
          <Text style={[styles.btnText, { color: '#FFFFFF' }]}>End Fasting</Text>
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({ 
  ...
  headerWrap: { paddingHorizontal: 16, paddingTop: 12, paddingBottom: 8, backgroundColor: '#FFFFFF' },
  headerRow: { height: 48, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#FFFFFF' },
  avatar: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#F8F9FA' },
  bigDate: { color: '#1a1a1a', fontSize: 28, fontWeight: '700' },
  sectionTitle: { color: '#1a1a1a', fontSize: 16, fontWeight: '700', paddingHorizontal: 16, paddingTop: 12, paddingBottom: 4 },
  timeRow: { flexDirection: 'row', gap: 16, paddingHorizontal: 16, paddingVertical: 12 },
  timeCol: { flex: 1 },
  timeBox: { height: 56, backgroundColor: '#F8F9FA', borderRadius: 12, alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: '#E5E5E5' },
  timeNum: { color: '#1a1a1a', fontSize: 18, fontWeight: '700' },
  center: { alignItems: 'center', justifyContent: 'center', marginTop: 6 },
  timeLabel: { color: '#4a4a4a', fontSize: 12 },
  progressWrap: { paddingHorizontal: 16, paddingVertical: 8 },
  rowBetween: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  progressTitle: { color: '#1a1a1a' },
  progressMeta: { color: '#4a4a4a', fontSize: 12 },
  ...
  tip: { color: '#4a4a4a', fontSize: 14, textAlign: 'center', paddingHorizontal: 16, paddingTop: 8, fontStyle: 'italic' },
  actionsRow: { flexDirection: 'row', gap: 12, paddingHorizontal: 16, paddingTop: 12 },
  btn: { height: 48, borderRadius: 12, justifyContent: 'center', alignItems: 'center', flex: 1 },
  btnMuted: { backgroundColor: '#F8F9FA', borderWidth: 1.5, borderColor: '#E5E5E5' },
  ...
  singleAction: { height: 40, borderRadius: 8, paddingHorizontal: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: '#F8F9FA' },
  singleActionText: { color: '#1a1a1a', fontWeight: '700', fontSize: 13 },
  ...
  rail: { width: 2, backgroundColor: '#E5E5E5', height: 16 },
  dot: { width: 8, height: 8, borderRadius: 4, backgroundColor: Colors.primary.main },
  timelineTitle: { color: '#1a1a1a', fontWeight: '500' },
  timelineSub: { color: '#6a6a6a' },
  avatarsRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 16, paddingTop: 8 },
  avatarWrap: { width: 28 },
  avatarSmall: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#F8F9FA', borderWidth: 3, borderColor: '#FFFFFF' },
  footerNote: { color: '#6a6a6a', fontSize: 12, paddingHorizontal: 16, paddingVertical: 8 },
