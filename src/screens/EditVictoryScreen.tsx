...
import { updateVictory, getVictoryById } from '../store/slices/victorySlice';
import { AppDispatch, RootState } from '../store';
import { UpdateVictoryPayload } from '../services/victoryService';
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Edit Victory</Text>
...
export default EditVictoryScreen;
