/**
 * Onboarding Screen 7 - Accountability & Support Setup
 * 
...
interface Onboarding7ScreenProps {
  navigation: any;
  route: {
    params?: {
      userData?: any;
 ...
 */
const Onboarding7Screen: React.FC<Onboarding7ScreenProps> = ({ navigation, route }) => {
