...
const Onboarding16Screen: React.FC<Props> = ({ navigation }) => {
  const dispatch = useAppDispatch();
  useEffect(() => { dispatch(setCurrentStep(16)); }, [dispatch]);
  return (
  ...
  <View style={styles.progress}><ProgressIndicator currentStep={16} totalSteps={30} variant="bars" showStepText={false} /></View>
        <View style={{ width: 40 }} />
      </View>
      <View style={styles.content}>
        <Text accessibilityRole="image" accessibilityLabel="Broken heart icon" style={styles.heartIcon}>💔</Text>
        <View style={styles.scriptureCard}>
          <Text style={styles.scriptureText}>“Blessed are the pure in heart, for they shall see God.”</Text>
          <Text style={styles.scriptureRef}>— Matthew 5:8</Text>
        </View>
        <Text style={styles.title}>Pornography destroys relationships</Text>
        <Text style={styles.subtitle}>
          It dulls your desire for real intimacy and replaces it with cravings for more
          pornography. Choose purity and pursue love that reflects Christ.
        </Text> 
...
const styles = StyleSheet.create({
  ...
  heartIcon: { fontSize: 56, textAlign: 'center', marginBottom: 16 },
  scriptureCard: {
...
export default Onboarding16Screen;
