...
import { createVictory } from '../store/slices/victorySlice';
import { AppDispatch, RootState } from '../store';
import { CreateVictoryPayload } from '../services/victoryService';
...
const CreateVictoryScreen = ({ navigation }: any) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Error', e.message || 'Failed to create victory.');
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Create a Victory</Text>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.textFieldContainer}>
            ...
            <ScrollView style={{ height: 250 }}>
              <RichEditor
                ref={richText}
                placeholder="Write your victory details..."
